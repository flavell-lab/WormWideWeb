            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="datasets", to="connectome.neuron"
                    ),
                ),
                (
                    "available_classes",
                    models.ManyToManyField(
                        related_name="datasets", to="connectome.neuronclass"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "synapse_type",
                    models.CharField(
                        choices=[("e", "electrical"), ("c", "chemical")],
                        db_index=True,
                        max_length=1,
                    ),
                ),
